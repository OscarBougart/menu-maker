...
// ── CARTOUCHES (landscape page frame, 653×460, stroke only) ─────────────────
const CARTOUCHES_H = {
  baroque:      mk('0 0 653 460',
    'M 28,16 Q 16,16 16,28 L 16,432 Q 16,444 28,444 L 625,444 Q 637,444 637,432 L 637,28 Q 637,16 625,16 Z ' +
    'M 32,22 Q 22,22 22,32 L 22,428 Q 22,438 32,438 L 621,438 Q 631,438 631,428 L 631,32 Q 631,22 621,22 Z', true),
  art_nouveau:  mk('0 0 653 460',
    'M 40,16 Q 16,16 16,40 L 16,420 Q 16,444 40,444 L 613,444 Q 637,444 637,420 L 637,40 Q 637,16 613,16 Z', true),
  victorian:    mk('0 0 653 460',
    'M 36,16 L 617,16 L 637,36 L 637,424 L 617,444 L 36,444 L 16,424 L 16,36 Z ' +
    'M 40,22 L 613,22 L 631,40 L 631,420 L 613,438 L 40,438 L 22,420 L 22,40 Z', true),
  minimal:      mk('0 0 653 460',
    'M 20,20 L 633,20 L 633,440 L 20,440 Z', true),
  art_deco:     mk('0 0 653 460',
    'M 50,16 L 603,16 L 637,50 L 637,410 L 603,444 L 50,444 L 16,410 L 16,50 Z ' +
    'M 52,20 L 601,20 L 633,52 L 633,408 L 601,440 L 52,440 L 20,408 L 20,52 Z', true),
  gothic:       mk('0 0 653 460',
    'M 16,80 Q 16,16 80,16 L 573,16 Q 637,16 637,80 L 637,380 Q 637,444 573,444 L 80,444 Q 16,444 16,380 Z ' +
    'M 22,80 Q 22,22 80,22 L 573,22 Q 631,22 631,80 L 631,380 Q 631,438 573,438 L 80,438 Q 22,438 22,380 Z', true),
  neoclassical: mk('0 0 653 460',
    'M 16,16 L 637,16 L 637,444 L 16,444 Z M 22,22 L 631,22 L 631,438 L 22,438 Z ' +
    'M 22,22 L 56,22 L 56,56 M 631,22 L 597,22 L 597,56 M 631,438 L 597,438 L 597,404 M 22,438 L 56,438 L 56,404', true),
  celtic:       mk('0 0 653 460',
    'M 24,16 Q 16,16 16,24 L 16,436 Q 16,444 24,444 L 629,444 Q 637,444 637,436 L 637,24 Q 637,16 629,16 Z ' +
    'M 30,24 Q 24,24 24,30 L 24,430 Q 24,436 30,436 L 623,436 Q 629,436 629,430 L 629,30 Q 629,24 623,24 Z', true),
  japanese:     mk('0 0 653 460',
    'M 16,16 L 593,16 L 637,60 L 637,444 L 16,444 Z', true),
  hairline:     mk('0 0 653 460',
    'M 14,14 L 639,14 L 639,446 L 14,446 Z M 18,18 L 635,18 L 635,442 L 18,442 Z M 22,22 L 631,22 L 631,438 L 22,438 Z', true),
  bauhaus:      mk('0 0 653 460',
    'M 16,16 L 637,16 L 637,444 L 16,444 Z ' +
    'M 16,16 A 14,14 0 1 0 16.01,16 M 637,16 A 14,14 0 1 0 637.01,16 ' +
    'M 16,444 A 14,14 0 1 0 16.01,444 M 637,444 A 14,14 0 1 0 637.01,444', true),
};
